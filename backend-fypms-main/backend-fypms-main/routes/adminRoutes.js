...
// const { getStudents, addGrades } = require('../controllers/studentController');
const {
  getAllStudents,
  getStudentById,
  updateGrades,
...
// router.post('/students/grades', addGrades);
router.get("/maincomponent", getAllStudents);
router.get("/maincomponent/:id", getStudentById);
router.put("/maincomponent/:id/grades", updateGrades);
