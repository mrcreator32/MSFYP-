...
const sourceDB = mongoose.createConnection(
  // "mongodb+srv://sourceDB:msfypsDB@msfyp.1ye4myn.mongodb.net/?retryWrites=true&w=majority&appName=MSFYP"
  "mongodb+srv://sourceDB:msfypsDB@msfyp.1ye4myn.mongodb.net/MSFYP"
);
...
const createClass = async (req, res, next) => {
 ...
 try {
    ...
    if (!sourceClass) {
      console.log("Source class not found:", classname);
      return next(
        new HttpError("Source class not found, so can't be created", 404)
      );
    }
